...
public class XCRoundRectImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public XCRoundRectImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.zhensheng);
        curRadius = ta.getInteger(R.styleable.zhensheng_zsCornerRadius, 20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (null != drawable) {
            ...
            Bitmap b = getRoundBitmap(bitmap, AppUtils.dp2px(getContext(),curRadius));
