...
public class HookCheckBox extends View {
     ...
     * 切换改变回调
     */
    private static OnCheckChangeListener mCheckListener;
    ...
    // 双向绑定 输入框内容
    @BindingAdapter(value = "hcb_is_check")
    public static void setcustomContent(HookCheckBox view, Boolean values) {
        view.setCheck(values);
//        mCheckListener.onCheckChange(values);
    }
